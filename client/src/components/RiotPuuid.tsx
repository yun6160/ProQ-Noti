...
const RiotPuuid = () => {
  ...
  const { data: accountData, error, refetch, isFetching } = useQuery({
    ...
    <div className="p-4">
      ...
      {accountData && (
        <div className="mt-4 p-4 border rounded">
          <p><strong>Game Name:</strong> {accountData.gameName || "N/A"}</p>
          <p><strong>Tag Line:</strong> {accountData.tagLine || "N/A"}</p>
